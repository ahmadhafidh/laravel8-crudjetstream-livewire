...
<!-- Mirrored from themes.3rdwavemedia.com/devcard/bs4/blog-home.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Nov 2020 12:17:37 GMT -->
<head>
...
<body>
    ...
    <header class="header text-center">	    
		<div class="force-overflow">
			<h1 class="blog-name pt-lg-4 mb-0"><a href="index">Simon Doe</a></h1>
			...
			<nav class="navbar navbar-expand-lg navbar-dark" >
				...
				<div id="navigation" class="collapse navbar-collapse flex-column" >
					...
					<ul class="navbar-nav flex-column text-left">
						<li class="nav-item">
							<a class="nav-link" href="index"><i class="fas fa-user fa-fw mr-2"></i>About Me</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="portofolio"><i class="fas fa-laptop-code fa-fw mr-2"></i>Portfolio</a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item active">
							<a class="nav-link" href="blog-home"><i class="fas fa-blog fa-fw mr-2"></i>Blog<span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item dropdown">
							...
							<a class="dropdown-item" href="project">Project Page</a>
			    ...
			    <div class="row">
					<div class="col-md-4 mb-3">
						<div class="card blog-post-card">
							...
							<div class="card-body">
								<h5 class="card-title"><a class="theme-link" href="blog-post">Top 3 JavaScript Frameworks</a></h5>
								...
								<p class="mb-0"><a class="more-link" href="blog-post">Read more &rarr;</a></p>
					...
					<div class="col-md-4 mb-3">
						<div class="card blog-post-card">
							...
							<div class="card-body">
								<h5 class="card-title"><a class="theme-link" href="blog-post">About Remote Working</a></h5>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient...</p>
								<p class="mb-0"><a class="more-link" href="blog-post">Read more &rarr;</a></p>
							</div>
							<div class="card-footer">
					...
					<div class="col-md-4 mb-3">
						<div class="card blog-post-card">
							...
							<div class="card-body">
								<h5 class="card-title"><a class="theme-link" href="blog-post">A Guide to Becoming a Full-Stack Developer</a></h5>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient...</p>
								<p class="mb-0"><a class="more-link" href="blog-post">Read more &rarr;</a></p>
							</div>
							<div class="card-footer">
					...
					<div class="col-md-4 mb-3">
						<div class="card blog-post-card">
							...
							<div class="card-body">
								<h5 class="card-title"><a class="theme-link" href="blog-post">High Performance JavaScript</a></h5>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient...</p>
								<p class="mb-0"><a class="more-link" href="blog-post">Read more &rarr;</a></p>
							</div>
							<div class="card-footer">
					...
					<div class="col-md-4 mb-3">
						<div class="card blog-post-card">
							...
							<div class="card-body">
								<h5 class="card-title"><a class="theme-link" href="blog-post">Learn React in 24 Hours</a></h5>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient...</p>
								<p class="mb-0"><a class="more-link" href="blog-post">Read more &rarr;</a></p>
							</div>
							<div class="card-footer">
					...
					<div class="col-md-4 mb-3">
						<div class="card blog-post-card">
							...
							<div class="card-body">
								<h5 class="card-title"><a class="theme-link" href="blog-post">How to Build Desktop Apps with HTML, CSS and JavaScript</a></h5>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient...</p>
								<p class="mb-0"><a class="more-link" href="blog-post">Read more &rarr;</a></p>
							</div>
							<div class="card-footer">
...
<!-- Mirrored from themes.3rdwavemedia.com/devcard/bs4/blog-home.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Nov 2020 12:17:40 GMT -->
</html>