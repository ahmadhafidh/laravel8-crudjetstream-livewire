...
<!-- Mirrored from themes.3rdwavemedia.com/devcard/bs4/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Nov 2020 12:16:30 GMT -->
<head>
...
<body>
	...
	<header class="header text-center">	    
		<div class="force-overflow">
			<h1 class="blog-name pt-lg-4 mb-0"><a href="index-2">Doel's</a></h1>
			...
			<nav class="navbar navbar-expand-lg navbar-dark" >
				...
				<div id="navigation" class="collapse navbar-collapse flex-column" >
					<div class="profile-section pt-3 pt-lg-0">
						...
						<div class="bio mb-3">Hi, my name is Doel's and I'm a senior software engineer. Welcome to my personal website!</div><!--//bio-->
					...
					<ul class="navbar-nav flex-column text-left">
						<li class="nav-item active">
							<a class="nav-link" href="index-2"><i class="fas fa-user fa-fw mr-2"></i>About Me<span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link" href="blog-home"><i class="fas fa-blog fa-fw mr-2"></i>Blog</a>
						</li>
						<li class="nav-item">
	...
	<div class="main-wrapper">
			...
			<div class="container">
				<div class="profile-teaser media flex-column flex-lg-row">
					...
					<div class="media-body">
						<h2 class="name font-weight-bold mb-1">Doel's</h2>
						<div class="tagline mb-3">A Complicated Human Being</div>
						...
						<div class="item">
							<div class="item-inner">
								...
								<div class="source-holder">
									...
									<div class="meta">
										<div class="name">Skrillex</div>
										<div class="info">Music Producer, DJ</div>
									</div>
								</div>
						    </div><!--//item-inner-->
						</div><!--//item-->
						...
						<div class="item">
							<div class="item-inner">
								...
								<div class="source-holder">
									...
									<div class="meta">
										<div class="name">Anne Hathaway</div>
										<div class="info">Actress</div>
									</div>
								</div>
						    </div><!--//item-inner-->
		...
		<section class="latest-blog-section p-3 p-lg-5">
			<div class="container">
				...
				<div class="text-center py-3"><a href="dashboard" class="btn btn-primary"><i class="fas fa-arrow-alt-circle-right mr-2"></i>Kembali ke dashboard</a></div>
			</div><!--//container-->
			
		</section><!--//latest-blog-section-->

		<footer class="footer text-center py-4">
			<small class="copyright">Copyright &copy; <a href="https://www.facebook.com/muhammad-rizqi-dhiaulhaq" target="_blank">Doel's</a></small>
		</footer>
...
<!-- Mirrored from themes.3rdwavemedia.com/devcard/bs4/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Nov 2020 12:17:29 GMT -->
</html> 