...
<!-- Mirrored from themes.3rdwavemedia.com/devcard/bs4/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Nov 2020 12:17:29 GMT -->
<head>
				...
				<div id="navigation" class="collapse navbar-collapse flex-column" >
					...
					<ul class="navbar-nav flex-column text-left">
						<li class="nav-item active">
							<a class="nav-link" href="index"><i class="fas fa-user fa-fw mr-2"></i>About Me<span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item">
