...
<html lang="en"> 
<head>
    <title>Nova - Bootstrap 4 Landing Page Template For Mobile Apps</title>
    ...
    <!-- FontAwesome JS-->
	<script defer src="assetss/fontawesome/js/all.min.js"></script>
    
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="assetss/plugins/jquery-flipster/dist/jquery.flipster.min.css">
    
    
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="assetss/css/theme.css">

</head> 

<body> 
    <div class="demo-banner py-3 text-white fixed-right font-weight-bold theme-bg-secondary text-white">
        @if (Route::has('login'))
            <div>
                @auth
                    <a href="{{ url('/dashboard') }}" class="ml-3 text-white underline">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="ml-3 text-white underline">Login</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-3 text-white underline">Register</a>
                    @endif
                @endif
            </div>
        @endif
        ...
        <div class="branding">
            ...
            <div class="container position-relative">
				...
				<nav class="navbar navbar-expand-lg" >
                    <h1 class="site-logo"><a class="navbar-brand" href="/"><img class="logo-icon" src="assetss/images/logo-icon.svg" alt="logo"> <span class="logo-text">NOVA</span></a></h1>
				</nav>
			    ...
			    <div class="col-12 col-md-6 pt-3 pt-md-4">
				    ...
				    <div class="cta-btns">
					    ...
					    <ul class="app-stores list-unstyled list-inline mx-auto mx-md-0 d-inline-block">
						    <li class="list-inline-item mr-3"><a href="#"><img class="ios" src="assetss/images/appstore-apple.svg" alt="app-store"></a></li>
						    <li class="list-inline-item"><a href="#"><img class="android" src="assetss/images/appstore-android.svg" alt="google play"></a></li>
					    </ul>
				    </div>
			    </div>
		    </div><!--//row-->
		    ...
		    <div class="logos-row row mx-auto"> 
	            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
		            <div class="item-inner">
		                <img src="assetss/images/logos/logo-1.svg" alt="logo">
		            </div><!--//item-inner-->
	            </div><!--//item-->
	            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
		            <div class="item-inner">
		                <img src="assetss/images/logos/logo-2.svg" alt="logo">
		            </div><!--//item-inner-->
	            </div><!--//item-->
	            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
		            <div class="item-inner">
		                <img src="assetss/images/logos/logo-3.svg" alt="logo">
		            </div><!--//item-inner-->
	            </div><!--//item-->
	            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
		            <div class="item-inner">
		                <img src="assetss/images/logos/logo-4.svg" alt="logo">
		            </div><!--//item-inner-->
	            </div><!--//item-->
	            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
		            <div class="item-inner">
		                <img src="assetss/images/logos/logo-5.svg" alt="logo">
		            </div><!--//item-inner-->
	            </div><!--//item-->
	            <div class="item col-6 col-md-4 col-lg-2 mb-3 mb-lg-0">
		            <div class="item-inner">
		                <img src="assetss/images/logos/logo-6.svg" alt="logo">
		            </div><!--//item-inner-->
	            </div><!--//item-->
		    ...
		    <div class="row">
		        <div class="item col-12 col-lg-4">
				    <div class="item-inner text-center p-3 p-lg-5">
					    <img class="mb-3" src="assetss/images/icon-target.svg" alt="" />
					    <h5>Focused on UX</h5>
			    ...
			    <div class="item col-12 col-lg-4">
				    <div class="item-inner text-center p-3 p-lg-5">
					    <img class="mb-3" src="assetss/images/icon-rocket.svg" alt="" />
					    <h5>Convert Users</h5>
					    <div>Use this area to list your app's key benefits. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. </div>
				    </div><!--//item-inner-->
			    </div><!--//item-->
			    <div class="item col-12 col-lg-4">
				    <div class="item-inner text-center p-3 p-lg-5">
					    <img class="mb-3" src="assetss/images/icon-cogs.svg" alt="" />
	    ...
	    <div class="container py-lg-5">
		    ...
		    <div class="row pt-5 mb-5">
			    ...
			    <div class="col-12 col-md-6 col-xl-5 offset-xl-1 d-none d-md-block">
				    <img class="product-figure product-figure-1 img-fluid" src="assetss/images/product-figure-1.png" alt="" />
			    </div>
		    ...
		    <div class="row">
			    <div class="col-12 col-md-6 col-xl-5 order-md-2 pr-xl-3 d-none d-md-block">
				    <img class="product-figure product-figure-2 img-fluid" src="assetss/images/product-figure-2.png" alt="" />
			    </div>
			    ...
			    <div class="flip-items pb-5">
				    <div class="flip-item text-center text-md-left">
					    <div class="item-inner shadow-lg rounded">
						    ...
						    <div class="source media flex-column flex-md-row">
							    <img class="source-profile rounded-circle mr-md-3 mx-auto mx-md-0" src="assetss/images/users/user-1.jpg" alt="" />
				    ...
				    <div class="flip-item">
					    <div class="item-inner shadow-lg rounded">
						    ...
						    <div class="source media ">
							    <img class="source-profile rounded-circle mr-3" src="assetss/images/users/user-2.jpg" alt="" />
							    <div class="source-info media-body pt-3">
								    <div>Helen Owens</div>
								    <div>New York, US</div>
							    </div>
				    ...
				    <div class="flip-item">
					    <div class="item-inner shadow-lg rounded">
						    ...
						    <div class="source media">
							    <img class="source-profile rounded-circle mr-3" src="assetss/images/users/user-3.jpg" alt="" />
							    <div class="source-info media-body pt-3">
				    ...
				    <div class="flip-item">
					    <div class="item-inner shadow-lg rounded">
						    ...
						    <div class="source media">
							    <img class="source-profile rounded-circle mr-3" src="assetss/images/users/user-4.jpg" alt="" />
							    <div class="source-info media-body pt-3">
				    ...
				    <div class="flip-item">
					    <div class="item-inner shadow-lg rounded">
						    ...
						    <div class="source media">
							    <img class="source-profile rounded-circle mr-3" src="assetss/images/users/user-5.jpg" alt="" />
							    <div class="source-info media-body pt-3">
				    ...
				    <div class="flip-item">
					    <div class="item-inner shadow-lg rounded">
						    ...
						    <div class="source media">
							    <img class="source-profile rounded-circle mr-3" src="assetss/images/users/user-6.jpg" alt="" />
							    <div class="source-info media-body pt-3">
								    <div>Tony Cheng</div>
								    <div>San Francisco, US</div>
							    </div>
				    ...
				    <div class="flip-item">
					    <div class="item-inner shadow-lg rounded">
						    ...
						    <div class="source media">
							    <img class="source-profile rounded-circle mr-3" src="assetss/images/users/user-7.jpg" alt="" />
							    <div class="source-info media-body pt-3">
    ...
    <!-- Javascript -->          
    <script type="text/javascript" src="assetss/plugins/jquery-3.4.1.min.js"></script>
    <script type="text/javascript" src="assetss/plugins/popper.min.js"></script>
    <script type="text/javascript" src="assetss/plugins/bootstrap/js/bootstrap.min.js"></script>  
    
    <!-- Page Specific JS -->
    <script type="text/javascript" src="assetss/plugins/jquery-flipster/dist/jquery.flipster.min.js"></script> 
    <script type="text/javascript" src="assetss/js/flipster-custom.js"></script> 
